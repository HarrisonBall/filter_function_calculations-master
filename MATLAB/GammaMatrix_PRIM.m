function [GAMMA_PRIM] = GammaMatrix_PRIM(theta,pitime)
...
%This m-file outputs the standard GammaMatrix-parametrization of a primitive
%theta-rotation about the sigma-x axis of the Bloch sphere. 
...
GAMMA_PRIM  = cat(2,Omega_col,tau_col,theta_col,nhat_col);
