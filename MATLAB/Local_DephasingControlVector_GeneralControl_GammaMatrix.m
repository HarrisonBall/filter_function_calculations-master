...
function  LOCAL_DEPHASING_CONTROL_VECTOR_GENERAL_CONTROL_GAMMA_MATRIX = Local_DephasingControlVector_GeneralControl_GammaMatrix(GammaMatrix,l,w_col)
...
% Local_DephasingControlVector_GeneralControl_GammaMatrix(GammaMatrix,l,w_col)
...
%This function outputs the w-domain local dephasing control vector
%associated with the "lth" pulse segment of a piecewise-constant 
%control pulse sequence. That is, the 3rd row of the w-domain local control 
...
%copied from the 3rd row of the matrix output of the m-file 
...
LOCAL_DEPHASING_CONTROL_VECTOR_GENERAL_CONTROL_GAMMA_MATRIX = [RzxPlwGENERAL RzyPlwGENERAL RzzPlwGENERAL];
